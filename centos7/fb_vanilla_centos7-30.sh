...
FB_VER=3.0
FB_URL="https://github.com/FirebirdSQL/firebird/releases/download/v3.0.11/Firebird-3.0.11.33703-0.amd64.tar.gz"
TMP_DIR=$(mktemp -d)
OLD_DIR=$(pwd -P)
...
yum install -y wget ncurses libtommath icu lsof mc
