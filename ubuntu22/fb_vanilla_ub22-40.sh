...
FB_VER=4.0
FB_URL="https://github.com/FirebirdSQL/firebird/releases/download/v4.0.4/Firebird-4.0.4.3010-0.amd64.tar.gz"
TMP_DIR=$(mktemp -d)
OLD_DIR=$(pwd -P)
...
apt update
apt install --no-install-recommends -y net-tools libtommath1 libicu70 wget unzip gettext libncurses5 curl tar tzdata locales sudo xz-utils file
