...
apt update
apt install --no-install-recommends -y net-tools libtommath1 libicu70 wget unzip gettext libncurses5 curl tar openjdk-8-jre tzdata locales sudo mc xz-utils file libatomic1
