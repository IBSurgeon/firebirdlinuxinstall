...
registerDB(){
	...
	java -jar /opt/hqbird/dataguard.jar -regdb="$FB_ROOT/examples/empbuild/employee.fdb" -srvver=2 -config-directory="/opt/hqbird/conf" -default-output-directory="/opt/hqbird/outdataguard"
	...
	chown -R firebird:firebird /opt/hqbird $FB_ROOT/firebird.conf $FB_ROOT/aliases.conf
}
