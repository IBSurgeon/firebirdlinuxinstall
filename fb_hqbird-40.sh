...
registerDB(){
	...
	java -jar /opt/hqbird/dataguard.jar -regdb="$FB_ROOT/examples/empbuild/employee.fdb" -srvver=4 -config-directory="/opt/hqbird/conf" -default-output-directory="/opt/hqbird/outdataguard"
