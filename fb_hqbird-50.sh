...
prepareDebian11(){
	apt update -y || exitScript 1 "Error updating OS"
...
prepareSuse15(){
	...
	ln -s libtommath.so.1 /usr/lib64/libtommath.so.0 || exitScript 1 "Error installing software"
	configureCentosFW 8082,8083,8721,3050,3059,40000
}
...
prepareUbuntu22(){
	apt update || exitScript 1 "Error updating OS"
	apt install --no-install-recommends -y net-tools libtommath1 libicu70 wget unzip gettext libncurses5 curl tar openjdk-8-jre tzdata locales sudo mc xz-utils file bsdmainutils || exitScript 1 "Error installing software"
	ln -s libtommath.so.1 /usr/lib/x86_64-linux-gnu/libtommath.so.0
	locale-gen "en_US.UTF-8"
}
...
prepareUbuntu24(){
	apt update || exitScript 1 "Error updating OS"
	apt install --no-install-recommends -y ca-certificates net-tools wget unzip gettext libncurses6 curl tar tzdata locales sudo mc xz-utils file bsdmainutils libtommath1 libicu74 openjdk-8-jre || exitScript 1 "Error installing software"
	ln -s libtommath.so.1 /usr/lib/x86_64-linux-gnu/libtommath.so.0
...
prepareUbuntu26(){
	apt update || exitScript 1 "Error updating OS"
	apt install --no-install-recommends -y ca-certificates net-tools wget unzip gettext libncurses6 curl tar tzdata locales sudo mc xz-utils file libtommath1 libicu78 openjdk-8-jre || exitScript 1 "Error installing software"
	ln -s libtommath.so.1 /usr/lib/x86_64-linux-gnu/libtommath.so.0
	ln -s libncurses.so.6 /usr/lib/x86_64-linux-gnu/libncurses.so.5
	locale-gen "en_US.UTF-8"
}
